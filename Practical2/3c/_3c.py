...
class Cylinder(Shape):
    def __init__(self, colour, radius, height, X, Y):
        ...
        self._height = height
    def get_area(self):
        return 2*math.pi*self._base.get_radius()*self._height + 2*math.pi*self._base.get_radius()**2
    def get_volume(self):
        return math.pi*self._base.get_radius()**2*self._height
    def __str__(self):
       return "Cylinder of radius " + str(self._base.get_radius()) + ", colour " + self.get_colour() +", volume " + str(self.get_volume())
